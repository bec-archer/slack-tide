      ...
      <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
        <div className="max-w-md w-full card-static p-8 text-center animate-fade-in">
          ...
          <p className="text-text-secondary mb-6">
            ...
            Click the link to activate your business account.
          </p>
          <p className="text-text-tertiary text-xs mb-4">
            After confirming, you&apos;ll be able to register your shop.
          </p>
          <button
            onClick={() => {
    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
      <div className="max-w-md w-full animate-fade-in">
        <div className="text-center mb-8">
          <Link href="/shop" className="inline-block mb-3">
            <QRSTKRLogo id="shop-auth" height={36} />
          </Link>
          ...
          <p className="text-text-secondary">
            {mode === 'signin'
              ...
              : 'Create a business account for your shop'}
          </p>
        </div>

        {/* Business account notice */}
        <div className="bg-accent/5 border border-accent/20 rounded-xl p-3 mb-4 text-center">
    ...
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-bg-primary">
        <div className="animate-pulse-bullseye">
          <QRSTKRLogo id="shop-auth-loading" height={32} />
        </div>
      </div>
    }>
      <ShopAuthForm />
